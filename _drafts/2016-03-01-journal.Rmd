...
`r paste("-", cptid, ":", gsub("^\\[1\\] ", "", format(bib_metadata(DOI))))` [<i class="fa fa-file-pdf-o"></i>PDF](`r paste0("ftp://172.21.61.202/cpt%20documents/BookJournal/2017/Journal/", cptid, "/", cptid, ".pdf")`)
