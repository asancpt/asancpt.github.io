...
summary: <eb>ÖºÎ¨<b8> Î∞úÌëú <ec>ùº<ec>†ï<ec>ûÖ<eb>ãà<eb>ã§.
---
...
- 2017-01-06-gcpark-ebola :[1] "BibEntry" "bibentry"

```
## Error in parse_Rd(Rd, encoding = encoding, fragment = fragment, ...): unused argument (class = "BibEntry")
```
...
```
## Error in textConnection(x): invalid 'text' argument
```

[1] B. S. Halpern, H. M. Regan, H. P. Possingham, et al.
...
https://doi.org/10.1111%2Fj.1461-0248.2005.00827.x}.>
[1] B. S. Halpern, H. M. Regan, H. P. Possingham, et al.
"Accounting for uncertainty in marine reserve design". In:
_Ecology Letters_ 9.1 (2006), pp. 2-11. DOI:
10.1111/j.1461-0248.2005.00827.x. <URL:
