...
```
## Error in GetBibEntryWithDOI(DOI): failed to parse the returned BibTeX results; if delete.file is FALSE, you can try viewing and editing the file: /var/folders/sb/xm5b858d4077jdfsbfd8fk0r0000gn/T//RtmpUP2wNa/file5cf164a4b57c.bib
```
